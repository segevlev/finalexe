...
class Findperson extends React.Component{
  ...
  componentDidMount(){
    ...
    url= "http://localhost:58499/api/person/datatable";
    else url = 'http://proj.ruppin.ac.il/bgroup68/test1/tar5/api/person/datatable';
    fetch(url).then(response => response.json()).then(arr => this.setState({
      arr:arr
